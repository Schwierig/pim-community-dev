Feature: Update price fields
  ...
  Scenario: Successfully update a price field
    ...
    Then I should get the following products after apply the following updater to it:
      ...
      | BOX4    | [{"type": "set_data", "field": "price", "data": [{"data": "5", "currency": "EUR"}], "locale": "fr_FR", "scope": null}, {"type": "set_data", "field": "price", "data": [{"data": "5", "currency": "USD"}], "locale": "fr_FR", "scope": null}] | {"values": {"price": [{"locale": "fr_FR", "scope": null, "data": [{"data": 5, "currency": "EUR"}, {"data": 5, "currency": "USD"}]}]}}    |
      | BOX5    | [{"type": "set_data", "field": "price", "data": [{"data": "5", "currency": "EUR"}], "locale": "fr_FR", "scope": null}, {"type": "set_data", "field": "price", "data": [], "locale": "fr_FR", "scope": null}]                                 | {"values": {"price": [{"locale": "fr_FR", "scope": null, "data": [{"data": 5, "currency": "EUR"}]}]}}                                    |
