...
//    function it_normalizes_option_code_when_field_name_is_provided(
//        AttributeOptionNormalizer $attributeOptionNormalizerStandard,
//        TranslationNormalizer $translationNormalizer,
...
//            ->willReturn(true);
//        $attributeOptionNormalizerStandard->normalize(
//            $attributeOption,
//            'standard',
//            ['field_name' => 'color']
//        )->willReturn([
...
//        ]);
//
//        $this->normalize($attributeOption, null, [])->shouldReturn(['color' => 'red']);
//    }
    ...
    //$this->normalize($attributeOption, null, ['field_name' => 'color'])->shouldReturn(['color' => 'red']);
    //$this->normalize($attributeOption, null, ['locales' => ['en_US', 'fr_FR', 'de_DE']])->shouldReturn([
}
